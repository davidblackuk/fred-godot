...
func _ready():
	...
	show_debug_check_box.button_pressed = GameManager.game_state.debug_mode
	god_mode_check_box.button_pressed = GameManager.game_state.god_mode
...
func _on_ShowDebug_toggled(button_pressed):
	GameManager.game_state.debug_mode = button_pressed


func _on_GodMode_toggled(button_pressed):
	GameManager.game_state.god_mode = button_pressed
